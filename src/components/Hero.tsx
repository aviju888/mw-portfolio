    ...
    <section className="relative min-h-[90vh] sm:min-h-screen w-full overflow-hidden flex items-center bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-2 sm:gap-10 lg:gap-24 py-4 sm:py-16 md:py-24">
            {/* Text content */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
              className="flex flex-col w-full lg:w-3/5 order-2 lg:order-1 lg:pr-4 mt-2 lg:mt-0"
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-none mb-4 sm:mb-8 text-[var(--heading-color)] text-center lg:text-left">
                <span className="block mb-2 sm:mb-4">Monica Wang</span>
              ...
              <p className="text-sm sm:text-lg text-[var(--text-color)] mb-5 sm:mb-10 bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-100 lg:max-w-[90%]">
            ...
            <motion.div
              ...
              className="flex-shrink-0 mb-2 lg:mb-0 order-1 lg:order-2 lg:w-2/5 flex justify-center lg:pl-4"
            >
