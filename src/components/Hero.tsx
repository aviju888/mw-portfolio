      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-8 py-8 sm:py-16 md:py-24">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-none mb-3 sm:mb-6 text-[var(--heading-color)]">
              <span className="block mb-1 sm:mb-2">Monica Wang</span>
              <span className="text-2xl sm:text-3xl lg:text-4xl font-medium text-[var(--secondary)]">UC Berkeley</span>
            </h1>
